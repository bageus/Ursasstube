...
3. 🔄 Частично: удалена часть дублей в button-style блоках, финальная зачистка остаётся.

### Этап 3 (1 спринт)
1. 🔄 Частично: добавлены feature/core/integration entry-points, начат перенос точек входа.
2. 🔄 Частично: добавлены thin-adapters (re-export) для обратной совместимости.
