...
- [x] **Этап 3 (частично):** visibility lifecycle переведён на runtime event `ursas:app-visibility-changed`; audio pause/resume синхронизирован с DOM/Phaser runtime.
