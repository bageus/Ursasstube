...
Core platform modules are now loaded directly as ESM (`js/logger.js`, `js/config.js`, `js/request.js`, `js/api.js`, `js/security.js`, `js/assets.js`, `js/state.js`, `js/input.js`, `js/audio.js`, `js/particles.js`, `js/perf.js`, `js/walletconnect.js`, `js/ui.js`) before the generated legacy compatibility bundle.
