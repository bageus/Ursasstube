...
const DOM_IDS = {
  ...
  pmReferralCode: 'pmReferralCode',
  pmReferralCount: 'pmReferralCount',
  pmCopyReferralCodeBtn: 'pmCopyReferralCodeBtn',
  pmCopyWebReferralBtn: 'pmCopyWebReferralBtn',
  pmCopyTelegramReferralBtn: 'pmCopyTelegramReferralBtn',
  pmTelegramReferralRow: 'pmTelegramReferralRow',
  pmReferralApplyInput: 'pmReferralApplyInput',
  pmReferralApplyBtn: 'pmReferralApplyBtn',
  pmReferralHint: 'pmReferralHint',
  pmReferralError: 'pmReferralError',
  pmReferralAppliedState: 'pmReferralAppliedState',
