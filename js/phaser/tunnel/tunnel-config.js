...
const PERIODIC_STRIPE_BASE_ALPHA = 0.075;
const PERIODIC_STRIPE_MAX_ALPHA = 0.62;
const PERIODIC_STRIPE_RAY_LINE_WIDTH = 2.1;
const PERIODIC_STRIPE_RAY_GLOW_LINE_WIDTH = 5.4;
const PERIODIC_STRIPE_RAY_SPARSE_NOISE_THRESHOLD = 0.56;
