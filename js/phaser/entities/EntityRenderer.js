...
import { initPlayerScarf, renderPlayerScarf } from './player-scarf.js';
...
class EntityRenderer {
  ...
  constructor(scene) {
    ...
    this.playerScarfGraphics = null;
    this.playerScarfAnchor = { x: 0, y: 0 };
    this.playerScarfPoints = [];
  ...
  create() {
    ...
    this.playerScarfGraphics = this.scene.add.graphics();
    this.playerLayer.add(this.playerScarfGraphics);
    initPlayerScarf(this);
  ...
  destroy() {
    ...
    this.playerScarfGraphics?.destroy();
  ...
  renderPlayer() {
    ...
    renderPlayerScarf(this, player, projection, FRAME_MS_60FPS);
  }
  renderObjects() {
